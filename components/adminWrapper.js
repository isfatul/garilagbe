...
const font = localFont({
  src: "../pages/assets/font/TeX-Gyre-Adventor/texgyreadventor-regular.otf",
});
              ...
              <div className="flex items-center ms-3">
                <div>
                  <button
                    ...
                    // onClick={() => {
                    //   document
                    //     .querySelector("#dropdown-user")
                    //     .classNameList.toggle("hidden");

                    //   document
                    //     .querySelector("#dropdown-user")
                    //     .classNameList.toggle("block");
                    // }}
                  >
            ...
            <ul className="space-y-2 font-medium">
              ...
              <li>
                <button
                  ...
                  onClick={() => {
                    document
                      .querySelector("#dropdown-example")
